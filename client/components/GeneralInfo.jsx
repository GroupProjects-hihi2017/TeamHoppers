    ...
    <div className='wallpaper-no-border'>
      <div className='info-container'>
        ...
        <hr></hr>
          ...
          <p className='info-text'>Wellington City Council issues free recycling bags from May-June. During alternative months you can purchase your recycling bags from the Council Service Centre, or Johnsonville, Kilbirnie, Newtown, or Tawa libraries. If you live in the suburbs you can use a council wheelie bin or recycling bags for paper, metals, and other household items. Make sure you separate any glassware. Glass bottles and jars can be recycled in the council issued 45-litre recycling crate.
          </p>
        ...
        <hr></hr>
          ...
          <p className='info-text'>
            Just a few pointers to make your recycling efforts more productive:</p>
