    ...
    .then(function() {
      return knex('orgs').insert([{
        ...
        },
        {
          ...
          org_info: "Food Rescue organzation - Collects surplus food products from all over Wellington to deliver to community groups to feed nutritious meals to those who need it most, reducing food waste and helping people in the community.",
          org_location: " "
        },
        {
          org_id: 66005,
        ...
        {
          org_id: 66006,
          org_name: "Wellington City Council green recycling bags or bin",
          org_address: "",
          org_url: "",
          org_img: "",
          org_info: "",
